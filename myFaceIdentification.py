# -*- coding: utf-8 -*-
"""
Created on Mon Apr 23 14:00:00 2019

@author: Nadia, Tania and Anina
#The group project is based on the following website: https://medium.com/data-science-lab-amsterdam/face-recognition-with-python-in-an-hour-or-two-d271324cbeb3
"""

print("please insert a high-quality current portrait image of the person you want to identify in XX")
...
# increase to make recognition less strict, decrease to make more strict
MAX_DISTANCE = 0.6¨
# increase to make recognition less strict, decrease to make more strict
MAX_DISTANCE = 2
WINDOW_NAME = "Face ID"
...
#create an empty list in order to later add names:
names = {}
...
def paint_detected_face_on_image(frame, location, name=None):
   ...
   if name is None:
    ...
    # Draw a label with the corresponding name below the face
...
def run_face_recognition(features, names):
    ...
    # Open a handler for the camera and start capturing the WebCam
